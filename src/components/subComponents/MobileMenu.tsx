...
export default function MobileMenu() {
  ...
  return (
    <>
    <button id="menu-btn" onClick={() => handleOpenMobileMenu()} className={open ? "block hamburger md:hidden focus:outline-none" :  "open block hamburger md:hidden focus:outline-none"}>
